#!/bin/bash
#SBATCH --job-name=760M-pile.slurm
...
OUTPUT_PATH=$six_ALL_CCFRSCRATCH/synched_exps/tr3j-760M-pile/
...
srun --jobid $SLURM_JOBID bash -c '$LAUNCHER --node_rank $SLURM_PROCID $CMD' 2>&1 | tee $OUTPUT_PATH/logs/tr3j-760M-pile.$SLURM_JOBID.out
