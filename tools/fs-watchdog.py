...
def main():
    ...
    # WORKFS - check both bytes and inodes w/ hard quotas of 4TB / 3M
    analyse_partition_bytes(partition_name="WORKFS", partition_path="/gpfsssd/worksf/projects/rech/six/", hard_limit_bytes=4*2**40, alert_bytes_threshold=0.85)
